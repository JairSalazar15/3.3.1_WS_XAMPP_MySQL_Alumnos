package tdm.ittepic.edu.a331_ws_xampp_mysql_alumnos;
...
public class Consultar extends AppCompatActivity {
    ...
    String IP = "http://192.168.1.73/datos1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        consulta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cone = new ServicioWeb2();
                cone.execute(GET_BY_ID,"consulta_id",idalumno,nombre.getText().toString(),domicilio.getText().toString());
            }
        });
        ...
        protected void onPostExecute(String s) {
            ...
            switch(opcion) {
                ...
                case "consulta_id":
                   ...
                   // String IDA="";
                    try {
                        JSONObject parentObject = new JSONObject(s); JSONObject userDetails = parentObject.getJSONObject("alumno");
